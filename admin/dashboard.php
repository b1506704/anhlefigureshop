...
<div class="cart content-wrapper">
    ...
    <form method="post">
        <div class="buttons">
            <a href="index.php?page=cdu" class="add">Thêm</a>
        </div>
        <table>
            <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <a href="index.php?page=cdu?id=<?=$product['MSHH']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                        <a href="index.php?page=cdu?id=<?=$product['MSHH']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
